...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{./assets/degree_vs_investment.png}
...
observed-vs-null-model.png
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{./assets/observed-vs-null-model.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{./assets/connectance-evolution.png}
...
null-model-distributions-significant-years.png
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{./assets/null-model-distributions-significant-years.png}
