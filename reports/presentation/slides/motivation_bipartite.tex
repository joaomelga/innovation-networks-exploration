...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{../figures/diagrams/classical_syndication_net.png}
    % \caption{Classical syndication model. All investors treated equally}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{../figures/diagrams/vc_investment_bipartite_pipeline.png}
