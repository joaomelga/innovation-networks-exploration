...
\hline
\end{tabular}
\caption{Summary statistics for the three largest investor communities.  Investment share refers to the proportion of all intra‑community syndicated investments attributed to each group.  NODF values and p‑values are based on degree‑preserving null models.  Community~2 displays significantly high nestedness, whereas Communities~0 and~1 have nestedness levels consistent with random expectations.}
...
To assess whether differences in funding distributions are statistically significant we computed Mann–Whitney U tests between communities for median funding amounts and found that Community~2 has significantly higher funding distributions than Communities~0 and~1 (p<0.001).
