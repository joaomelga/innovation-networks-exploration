...
To provide a concise overview of community characteristics, Table~\ref{tab:community_summary} summarises key statistics for the three largest communities.  In addition to the number of investors and co‑investment pairs, it reports the share of intra‑community investments and the observed nestedness and p‑value from degree‑preserving null models.  Only Community~2 exhibits nestedness significantly higher than expected under random mixing.

\begin{table}[ht]
\centering
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\textbf{Community} & \textbf{Investors} & \textbf{Co–investment pairs} & \textbf{Investment share} & \textbf{Observed NODF} & \textbf{p-value} \\
\hline
0 & 4{,}248 & 32{,}164 & 19.4\% & 0.028 & 0.59 \\
1 & 4{,}089 & 17{,}301 & 10.4\% & 0.015 & 0.72 \\
2 & 3{,}959 & 55{,}863 & 33.6\% & 0.088 & $<\!0.001$ \\
\hline
\end{tabular}
\caption{Three largest communities: investors, co‑investment pairs, share of intra‑community investments, observed NODF, and p‑value (degree‑preserving null model).}
...
\hline
\end{tabular}
\caption{Community~2 nestedness over time: mean NODF, mean Z‑score, and number of high‑nestedness years per period.}
